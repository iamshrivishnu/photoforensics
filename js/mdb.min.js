...
dropdownSelectors.on({
    ...
    function (t, e) {
        ...
        return function (t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, S, C, M, T, I, P, A, _, O, D, E, L, R, F, $, W, V, z, N, H, j, B, Y, q, X, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Ae = function (t) {
                    ...
                    var c = -1;
                    if (0 === l && (B = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), Ct("zoomGestureEnded")), Z = null, X || q || et || H)
                ...
                publicMethods: {
                    ...
                    setContent: function (t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), qe(0, l, c, n));
                            else {
                                ...
                                l.loading || Xe(l), a.allowProgressiveImg() && (!$e && $.transform ? je.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: e,
